...
///     Path::new("/home/user/projects/my-project"),
/// )?;
/// // ~/.claude/projects/-home-user-projects-my-project/memory/
/// ```
...
///
/// This produces names like `-home-user-projects-my-project` from
...
/// assert_eq!(
///     sanitize_cwd(Path::new("/home/user/projects/my-project")),
///     "-home-user-projects-my-project"
/// );
/// ```
...
mod tests {
    ...
    fn test_sanitize_cwd_basic() {
        let result = sanitize_cwd(Path::new("/home/user/projects/my-project"));
        assert_eq!(result, "-home-user-projects-my-project");
    }
    ...
    fn test_resolve_project_memory_dir_structure() {
        ...
        let result = resolve_project_memory_dir(Path::new("/home/user/projects/my-project"));
        ...
        assert!(
            path_str.contains("-home-user-projects-my-project"),
    ...
    fn test_resolve_transcript_dir_structure() {
        let result = resolve_transcript_dir(Path::new("/home/user/projects/my-project"));
        let path = result.expect("home dir should be resolvable");
        let path_str = path.to_string_lossy();
