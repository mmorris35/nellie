...
///     Path::new("/home/mmn/github/nellie-rs"),
/// )?;
/// // ~/.claude/projects/-home-mmn-github-nellie-rs/memory/
/// ```
...
///
/// This produces names like `-home-mmn-github-nellie-rs` from
/// `/home/mmn/github/nellie-rs`.
///
/// # Arguments
///
...
/// assert_eq!(
///     sanitize_cwd(Path::new("/home/mmn/github/nellie-rs")),
///     "-home-mmn-github-nellie-rs"
/// );
/// ```
...
mod tests {
    ...
    fn test_sanitize_cwd_basic() {
        let result = sanitize_cwd(Path::new("/home/mmn/github/nellie-rs"));
        assert_eq!(result, "-home-mmn-github-nellie-rs");
    }
    ...
    fn test_resolve_project_memory_dir_structure() {
        ...
        let result = resolve_project_memory_dir(Path::new("/home/mmn/github/nellie-rs"));
        ...
        assert!(
            path_str.contains("-home-mmn-github-nellie-rs"),
    ...
    fn test_resolve_transcript_dir_structure() {
        let result = resolve_transcript_dir(Path::new("/home/mmn/github/nellie-rs"));
        let path = result.expect("home dir should be resolvable");
        let path_str = path.to_string_lossy();
