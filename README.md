...
2. **UserPromptSubmit** — Runs `nellie inject` to search for context relevant to your prompt and inject it as a temporary rules file. Fail-open: if the server is down or slow, injection is silently skipped.
